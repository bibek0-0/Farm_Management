...
export default function OnePageGridEntry() {
  ...
  return (
    <div className="space-y-3 max-w-4xl mx-auto pb-24 sm:pb-8">
      ...
      {entryMode === 'collection' ? (
        <>
      {/* SEARCH BAR & STATUS FILTERS (ADMIN FRIENDLY MOBILE TOOLBAR) */}
      <div className="bg-white p-2.5 sm:p-4 rounded-xl sm:rounded-2xl border border-slate-200 shadow-xs space-y-2.5">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-14 py-2 sm:py-2.5 bg-slate-50 hover:bg-slate-100/70 focus:bg-white text-sm font-medium text-slate-900 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition"
            />
            {/* Search Clear Icon */}
          ...
          {/* Status Filter Chips: All, Pending, Entered (Full-width on mobile for easy thumb tapping) */}
          <div className="grid grid-cols-3 sm:flex items-center gap-1 bg-slate-100 p-1 rounded-xl border border-slate-200 flex-shrink-0">
            <button
              ...
              className={`py-1.5 px-2.5 text-xs font-bold rounded-lg text-center transition-all ${
                statusFilter === 'all'
